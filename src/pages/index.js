...
function Image(){
    return <div >
        <p style={{fontFamily: 'Segoe UI', color: "#18303B",fontSize: '16px'}}>Interested in attending the Hack Club Trip to Ryerson in Downtown Toronto for a cybersecurity event? <a href="https://drive.google.com/file/d/0B1AzkdN64xEDOFdPekJJX2lkWW9ET2tISUpobnlfSTBqazE0/view?usp=sharing" style={{color: "#9586EA"}}>Click here for forms</a> (please hand in your forms to Mr. Peters by Friday  Sept. 20th)<a href="https://dmz.ryerson.ca/canhack" style={{color: "#9586EA"}}>Click here for details about the event</a></p>
